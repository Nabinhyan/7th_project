...
plt.plot(original_data_plot,color = 'green', label='training')
plt.plot(test_data, color = 'blue', label='Actual Test Data')
plt.plot(predicted_data, color = 'orange', label='Prediction')
plt.grid()
plt.legend(loc='best')
    
#from prediction import *
#prediction_my(results_ar, training_data, test_data)
#prediction_my(results_ar, training_data, test_data)
